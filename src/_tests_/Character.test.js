...
test('testing levelUp method (health = 0)', () => {
  const character = new Character('лучник', 'Bowman');
  character.health = 0;
  expect(() => character.levelUp()).toThrow('Невозможно воскрешать мертвецов');
});
